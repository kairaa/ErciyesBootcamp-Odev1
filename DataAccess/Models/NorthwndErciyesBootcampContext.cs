...
public partial class NorthwndErciyesBootcampContext : DbContext
{
    public NorthwndErciyesBootcampContext()
    {
    }

    public NorthwndErciyesBootcampContext(DbContextOptions<NorthwndErciyesBootcampContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=.;Database=NORTHWND_ErciyesBootcamp;Trusted_Connection=True;TrustServerCertificate=True;");
